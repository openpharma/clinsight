...
if(rlang::is_interactive()){
  ...
  meta_path <- testthat::test_path("fixtures/testapp-raw/metadata_fake_study.xlsx")
  # meta_path <- testthat::test_path("fixtures/testapp-raw/metadata_study_example.xlsx") 
}
devtools::load_all()
