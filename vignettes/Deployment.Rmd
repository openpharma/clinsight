...
Depending on the configuration settings chosen, a credentials database will be created (for deployments using `shinymanager`) In addition, a path study data and metadata can be provided in the configuration file.
