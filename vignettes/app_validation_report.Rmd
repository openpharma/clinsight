...
|----|----|----|----|
| 1 | Secure Authentication and Authorization | Restrict access *(only applicable for Shinymanager deployment). Secure authentication for accessing the virtual machine is validated in the deployment validation document.* | [app_authentication](#app_authentication) |
...
package (version 1.0.7, developed by POSIT) to maintain consistent
