...
##### ClinSight key columns {.key-cols}

Note that the following columns are considered key columns in `ClinSight`, meaning that these are used to distinguish unique records in the data:  `subject_id`,  `event_name`,  `item_group`, `form_repeat`, `item_name`.
