library(shinytest2)
describe(
  "mod_main_sidebar. Feature 1 | As a user, I want to be able to view the main sidebar that 
    ...
    a query for the selected active form and participant.", 
  {
    ...
    it("Scenario 1. I expect that I can open a modal for creating a query after clicking the 'create query' button", {
    ...
    it("Scenario 2. Hide review panel. Given test a data frame with random data,
