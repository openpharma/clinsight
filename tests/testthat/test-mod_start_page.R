...
# describe(
#   "mod_start_page. Feature 2 | As a user, I want to be able to get an overview of all 
...
#     #   {
#     #   app_data <- get_appdata(clinsightful_data, metadata)
