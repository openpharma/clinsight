...
This will install all the required packages with their intended versions. Below, `renv::lockfile_read()$R` shows the R version and libraries used at the time this README file was rendered. It is recommended launch the project using the same R version, otherwise errors might occur during installation.
